...
test('Contract In Review -  Advanced Search with Tech Review status ', async ({ page }) => {
  try {
    // Step 1: Navigate to login page
    console.log('Step 1: Navigating to login page...');
    await page.goto('https://datnext-qa.algosium.com/login');
    ...
    // Select "Tech Review" status from the dropdown
       await page.locator('div:nth-child(7) > .AdvancedFilterTab_filter_header__FUxof').click();
       await page.locator('input[placeholder="Tech Review..."]').fill('veeramani');
       await page.getByTitle('Veeramani').click();
        await page.waitForTimeout(2000);

    // Click on Apply button to apply the filter
    await page.getByRole('button', { name: 'Apply' }).click();
    await page.waitForLoadState('networkidle');
    console.log('Advanced Search applied successfully with Tech Review status filter');
...
test('Contract In Review -  advanced search with Review stage  ', async ({ page }) => {
  try {
    ...
    // Select "Tech Review" status from the dropdown
       ...
       await page.locator('span[title="Technical"]').waitFor();
       await page.locator('span[title="Technical"]').click();
       console.log('Technical review stage selected successfully');
       await page.waitForTimeout(2000);

    // Click on Apply button to apply the filter
    await page.getByRole('button', { name: 'Apply' }).click();
    await page.waitForLoadState('networkidle');
    console.log('Advanced Search applied successfully with Technical Review status filter');
    await page.waitForTimeout(3000);
...
test('Contract In Review -  Technical Review change the project manager with save option   ', async ({ page }) => {
  try {
    // Step 1: Navigate to login page
    console.log('Step 1: Navigating to login page...');
    await page.goto('https://datnext-qa.algosium.com/login');
    ...
    await page.getByPlaceholder('Select...').nth(2).fill('Veeramani');
    await page.locator('[class*="suggestion_item"]').filter({ hasText: /^Veeramani$/ }) .click();
...
test('Contract In Review -  Technical Review Update the point to review  with save option   ', async ({ page }) => {
  try {
    // Step 1: Navigate to login page
    console.log('Step 1: Navigating to login page...');
    await page.goto('https://datnext-qa.algosium.com/login');
...
test('Contract In Review -  Technical Reviewer with Approval   ', async ({ page }) => {
  try {
    // Step 1: Navigate to login page
    console.log('Step 1: Navigating to login page...');
    await page.goto('https://datnext-qa.algosium.com/login');
...
test('Contract In Review -  Technical Reviewer with Rejected    ', async ({ page }) => {
  try {
    // Step 1: Navigate to login page
    console.log('Step 1: Navigating to login page...');
    await page.goto('https://datnext-qa.algosium.com/login');
