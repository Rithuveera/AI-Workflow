    ...
    try {
        ...
        const result = await page.evaluate(async () => {
            ...
            for (let i = 0; i < ths.length; i++) {
                ...
                const after = document.querySelector('tbody tr td')?.innerText;
                ...
                if (before === after) {
                    ...
                    if (svg) {
                        ...
                        await new Promise(r => setTimeout(r, 1000));
                        const afterSvg = document.querySelector('tbody tr td')?.innerText;
                        results[i].svgChanged = before !== afterSvg;
                    }
                }
            }
            return results;
